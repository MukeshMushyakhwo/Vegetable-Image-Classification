...
def main():
    ...
    uploaded_image = st.file_uploader("Upload an image  [Bean, Bitter Gourd, Bottle Gourd, Brinjal,Broccoli, Cabbage, Capsicum, Carrot, Cauliflower, Cucumber, Papaya, Potato, Pumpkin, Radish, Tomato]", type=["jpg", "jpeg", "png"])
